...
[Skip to main content](https://modelcontextprotocol.io/specification/2025-11-25/client/elicitation#content-area)
...
- [User Interaction Model](https://modelcontextprotocol.io/specification/2025-11-25/client/elicitation#user-interaction-model)
- [Capabilities](https://modelcontextprotocol.io/specification/2025-11-25/client/elicitation#capabilities)
- [Protocol Messages](https://modelcontextprotocol.io/specification/2025-11-25/client/elicitation#protocol-messages)
- [Elicitation Requests](https://modelcontextprotocol.io/specification/2025-11-25/client/elicitation#elicitation-requests)
- [Form Mode Elicitation Requests](https://modelcontextprotocol.io/specification/2025-11-25/client/elicitation#form-mode-elicitation-requests)
- [Requested Schema](https://modelcontextprotocol.io/specification/2025-11-25/client/elicitation#requested-schema)
- [Example: Simple Text Request](https://modelcontextprotocol.io/specification/2025-11-25/client/elicitation#example%3A-simple-text-request)
- [Example: Structured Data Request](https://modelcontextprotocol.io/specification/2025-11-25/client/elicitation#example%3A-structured-data-request)
- [URL Mode Elicitation Requests](https://modelcontextprotocol.io/specification/2025-11-25/client/elicitation#url-mode-elicitation-requests)
- [Example: Request Sensitive Data](https://modelcontextprotocol.io/specification/2025-11-25/client/elicitation#example%3A-request-sensitive-data)
- [Completion Notifications for URL Mode Elicitation](https://modelcontextprotocol.io/specification/2025-11-25/client/elicitation#completion-notifications-for-url-mode-elicitation)
- [Example](https://modelcontextprotocol.io/specification/2025-11-25/client/elicitation#example)
- [URL Elicitation Required Error](https://modelcontextprotocol.io/specification/2025-11-25/client/elicitation#url-elicitation-required-error)
- [Message Flow](https://modelcontextprotocol.io/specification/2025-11-25/client/elicitation#message-flow)
- [Form Mode Flow](https://modelcontextprotocol.io/specification/2025-11-25/client/elicitation#form-mode-flow)
- [URL Mode Flow](https://modelcontextprotocol.io/specification/2025-11-25/client/elicitation#url-mode-flow)
- [URL Mode With Elicitation Required Error Flow](https://modelcontextprotocol.io/specification/2025-11-25/client/elicitation#url-mode-with-elicitation-required-error-flow)
- [Response Actions](https://modelcontextprotocol.io/specification/2025-11-25/client/elicitation#response-actions)
- [Implementation Considerations](https://modelcontextprotocol.io/specification/2025-11-25/client/elicitation#implementation-considerations)
- [Statefulness](https://modelcontextprotocol.io/specification/2025-11-25/client/elicitation#statefulness)
- [URL Mode Elicitation for Sensitive Data](https://modelcontextprotocol.io/specification/2025-11-25/client/elicitation#url-mode-elicitation-for-sensitive-data)
- [URL Mode Elicitation for OAuth Flows](https://modelcontextprotocol.io/specification/2025-11-25/client/elicitation#url-mode-elicitation-for-oauth-flows)
- [Understanding the Distinction](https://modelcontextprotocol.io/specification/2025-11-25/client/elicitation#understanding-the-distinction)
- [Implementation Pattern](https://modelcontextprotocol.io/specification/2025-11-25/client/elicitation#implementation-pattern)
- [Error Handling](https://modelcontextprotocol.io/specification/2025-11-25/client/elicitation#error-handling)
- [Security Considerations](https://modelcontextprotocol.io/specification/2025-11-25/client/elicitation#security-considerations)
- [Safe URL Handling](https://modelcontextprotocol.io/specification/2025-11-25/client/elicitation#safe-url-handling)
- [Identifying the User](https://modelcontextprotocol.io/specification/2025-11-25/client/elicitation#identifying-the-user)
- [Form Mode Security](https://modelcontextprotocol.io/specification/2025-11-25/client/elicitation#form-mode-security)
- [Phishing](https://modelcontextprotocol.io/specification/2025-11-25/client/elicitation#phishing)
...
necessary information dynamically.Elicitation supports two modes:
...
## [​](https://modelcontextprotocol.io/specification/2025-11-25/client/elicitation#user-interaction-model) User Interaction Model
...
## [​](https://modelcontextprotocol.io/specification/2025-11-25/client/elicitation#capabilities) Capabilities
...
## [​](https://modelcontextprotocol.io/specification/2025-11-25/client/elicitation#protocol-messages) Protocol Messages

### [​](https://modelcontextprotocol.io/specification/2025-11-25/client/elicitation#elicitation-requests) Elicitation Requests

To request information from a user, servers send an `elicitation/create` request.All elicitation requests **MUST** include the following parameters:
...
### [​](https://modelcontextprotocol.io/specification/2025-11-25/client/elicitation#form-mode-elicitation-requests) Form Mode Elicitation Requests

Form mode elicitation allows servers to collect structured data directly through the MCP client.Form mode elicitation requests **MUST** either specify `mode: "form"` or omit the `mode` field, and include these additional parameters:

| Name              | Type   | Description                                                    |
| ----------------- | ------ | -------------------------------------------------------------- |
| `requestedSchema` | object | A JSON Schema defining the structure of the expected response. |

#### [​](https://modelcontextprotocol.io/specification/2025-11-25/client/elicitation#requested-schema) Requested Schema

The `requestedSchema` parameter allows servers to define the structure of the expected
response using a restricted subset of JSON Schema.To simplify client user experience, form mode elicitation schemas are limited to flat objects
with primitive properties only.The schema is restricted to these primitive types:
...
Supported formats: `email`, `uri`, `date`, `date-time` 2. **Number Schema**
...
4. **Enum Schema**Single-select enum (without titles):
...
#### [​](https://modelcontextprotocol.io/specification/2025-11-25/client/elicitation#example:-simple-text-request) Example: Simple Text Request
...
#### [​](https://modelcontextprotocol.io/specification/2025-11-25/client/elicitation#example:-structured-data-request) Example: Structured Data Request
...
### [​](https://modelcontextprotocol.io/specification/2025-11-25/client/elicitation#url-mode-elicitation-requests) URL Mode Elicitation Requests
...
authorization](https://modelcontextprotocol.io/specification/2025-11-25/basic/authorization)). Instead, it’s used when the MCP
...
#### [​](https://modelcontextprotocol.io/specification/2025-11-25/client/elicitation#example:-request-sensitive-data) Example: Request Sensitive Data
...
The same request could direct the user into an OAuth authorization flow, or a payment flow. The only difference is the URL and the message.**Request:**
...
### [​](https://modelcontextprotocol.io/specification/2025-11-25/client/elicitation#completion-notifications-for-url-mode-elicitation) Completion Notifications for URL Mode Elicitation

Servers **MAY** send a `notifications/elicitation/complete` notification when an
out-of-band interaction started by URL mode elicitation is completed. This allows clients to react programmatically if appropriate.Servers sending notifications:
...
- **MAY** wait for this notification to automatically retry requests that received a [URLElicitationRequiredError](https://modelcontextprotocol.io/specification/2025-11-25/client/elicitation#error-handling), update the user interface, or otherwise continue an interaction.
...
#### [​](https://modelcontextprotocol.io/specification/2025-11-25/client/elicitation#example) Example
...
### [​](https://modelcontextprotocol.io/specification/2025-11-25/client/elicitation#url-elicitation-required-error) URL Elicitation Required Error

When a request cannot be processed until an elicitation is completed, the server **MAY** return a [`URLElicitationRequiredError`](https://modelcontextprotocol.io/specification/2025-11-25/client/elicitation#error-handling) (code `-32042`) to indicate to the client that a URL mode elicitation is required. The server **MUST NOT** return this error except when URL mode elicitation is required.The error **MUST** include a list of elicitations that are required to complete before the original can be retried.Any elicitations returned in the error **MUST** be URL mode elicitations and have an `elicitationId` property.**Error Response:**
...
## [​](https://modelcontextprotocol.io/specification/2025-11-25/client/elicitation#message-flow) Message Flow

### [​](https://modelcontextprotocol.io/specification/2025-11-25/client/elicitation#form-mode-flow) Form Mode Flow

ServerClientUserServerClientUserServer initiates elicitationPresent elicitation UIComplete requestContinue processing with new informationelicitation/create (mode: form)Provide requested informationReturn user response

### [​](https://modelcontextprotocol.io/specification/2025-11-25/client/elicitation#url-mode-flow) URL Mode Flow

ServerClientUserUser Agent (Browser)ServerClientUserUser Agent (Browser)Server initiates elicitationUser interactionContinue processing with new informationelicitation/create (mode: url)Present consent to open URLProvide consentOpen URLAccept responseInteraction completenotifications/elicitation/complete (optional)

### [​](https://modelcontextprotocol.io/specification/2025-11-25/client/elicitation#url-mode-with-elicitation-required-error-flow) URL Mode With Elicitation Required Error Flow

ServerClientUserUser Agent (Browser)ServerClientUserUser Agent (Browser)Server needs authorizationClient notes the original request can be retried after elicitationUser interactiontools/callURLElicitationRequiredErrorPresent consent to open URLProvide consentOpen URLInteraction completenotifications/elicitation/complete (optional)Retry tools/call (optional)

## [​](https://modelcontextprotocol.io/specification/2025-11-25/client/elicitation#response-actions) Response Actions
...
1. **Accept** (`action: "accept"`): User explicitly approved and submitted with data - For form mode: The `content` field contains the submitted data matching the requested schema
...
## [​](https://modelcontextprotocol.io/specification/2025-11-25/client/elicitation#implementation-considerations) Implementation Considerations

### [​](https://modelcontextprotocol.io/specification/2025-11-25/client/elicitation#statefulness) Statefulness
...
Servers implementing elicitation **MUST** securely associate this state with individual users following the guidelines in the [security best practices](https://modelcontextprotocol.io/specification/2025-11-25/basic/security_best_practices) document. Specifically:

- State **MUST NOT** be associated with session IDs alone
- State storage **MUST** be protected against unauthorized access
- For remote MCP servers, user identification **MUST** be derived from credentials acquired via [MCP authorization](https://modelcontextprotocol.io/specification/2025-11-25/basic/authorization) when possible (e.g. `sub` claim)
...
### [​](https://modelcontextprotocol.io/specification/2025-11-25/client/elicitation#url-mode-elicitation-for-sensitive-data) URL Mode Elicitation for Sensitive Data
...
### [​](https://modelcontextprotocol.io/specification/2025-11-25/client/elicitation#url-mode-elicitation-for-oauth-flows) URL Mode Elicitation for OAuth Flows

URL mode elicitation enables a pattern where MCP servers act as OAuth clients to third-party resource servers.
Authorization with external APIs enabled by URL mode elicitation is separate from [MCP authorization](https://modelcontextprotocol.io/specification/2025-11-25/basic/authorization). MCP servers **MUST NOT** rely on URL mode elicitation to authorize users for themselves.

#### [​](https://modelcontextprotocol.io/specification/2025-11-25/client/elicitation#understanding-the-distinction) Understanding the Distinction

- **MCP Authorization**: Required OAuth flow between the MCP client and MCP server (covered in the [authorization specification](https://modelcontextprotocol.io/specification/2025-11-25/basic/authorization))
...
2. **The MCP server MUST NOT use the client’s credentials for the third-party service**: That would be [token passthrough](https://modelcontextprotocol.io/specification/2025-11-25/basic/security_best_practices#token-passthrough), which is forbidden
...
section](https://modelcontextprotocol.io/specification/2025-11-25/basic/security_best_practices#token-passthrough) of the Security
Best Practices document to understand why MCP servers cannot act as
pass-through proxies.

#### [​](https://modelcontextprotocol.io/specification/2025-11-25/client/elicitation#implementation-pattern) Implementation Pattern
...
MCP ServerMCP Client3rd Party RS3rd Party ASUser Agent (Browser)UserMCP ServerMCP Client3rd Party RS3rd Party ASUser Agent (Browser)UserNeeds 3rd-party authorization for userStore state (bind the elicitation request to the user)Client notes the tools/call request can be retried laterConfirm: user is logged into MCP Server or MCP ASConfirm: elicitation user matches session userUser interaction (OAuth flow):User consents to scoped MCP Server accessConfirm: redirect_uri belongs to MCP ServerBind tokens to MCP user identityRetrieve token bound to user identitytools/callURLElicitationRequiredError (mode: "url", url: "https://mcp.example.com/connect?...")Present consent to open URLProvide consentOpen URLAccept responseLoad connect routeRedirect to third-party authorization endpointLoad authorize routeredirect to MCP Server's redirect_uriload redirect_uri pageExchange authorization code for OAuth tokensGrants tokensnotifications/elicitation/complete (optional)Retry tools/callCall 3rd-party API
...
## [​](https://modelcontextprotocol.io/specification/2025-11-25/client/elicitation#error-handling) Error Handling
...
## [​](https://modelcontextprotocol.io/specification/2025-11-25/client/elicitation#security-considerations) Security Considerations
...
### [​](https://modelcontextprotocol.io/specification/2025-11-25/client/elicitation#safe-url-handling) Safe URL Handling
...
### [​](https://modelcontextprotocol.io/specification/2025-11-25/client/elicitation#identifying-the-user) Identifying the User

Servers **MUST NOT** rely on client-provided user identification without server verification, as this can be forged.
Instead, servers **SHOULD** follow [security best practices](https://modelcontextprotocol.io/specification/2025-11-25/basic/security_best_practices).Non-normative examples:

- Incorrect: Treat user input like “I am [joe@example.com](mailto:joe@example.com)” as authoritative
- Correct: Rely on [authorization](https://modelcontextprotocol.io/specification/2025-11-25/basic/authorization) to identify the user

### [​](https://modelcontextprotocol.io/specification/2025-11-25/client/elicitation#form-mode-security) Form Mode Security
...
To prevent this attack, the server **MUST** ensure that the user who started the elicitation request (the end-user who is accessing the server via the MCP client) is the same user who completes the authorization flow.There are many ways to achieve this and the best way will depend on the specific implementation.As a common, non-normative example, consider a case where the MCP server is accessible via the web and desires to perform a third-party authorization code flow.
...
Once that page ensures the same user, it can send the user to the third-party authorization server at `https://example.com/authorize?...` where a normal OAuth flow can be completed.In other cases, the server may not be accessible via the web and may not be able to use a session cookie to identify the user.
In this case, the server must use a different mechanism to identify the user who opens the elicitation URL is the same user who the elicitation was generated for.In all implementations, the server **MUST** ensure that the mechanism to determine the user’s identity is resilient to attacks where an attacker can modify the elicitation URL.

Was this page helpful?

YesNo

[Sampling](https://modelcontextprotocol.io/specification/2025-11-25/client/sampling) [Overview](https://modelcontextprotocol.io/specification/2025-11-25/server)
