...
[Skip to main content](https://modelcontextprotocol.io/specification/2025-11-25/basic/security_best_practices#content-area)
...
- [Introduction](https://modelcontextprotocol.io/specification/2025-11-25/basic/security_best_practices#introduction)
- [Purpose and Scope](https://modelcontextprotocol.io/specification/2025-11-25/basic/security_best_practices#purpose-and-scope)
- [Attacks and Mitigations](https://modelcontextprotocol.io/specification/2025-11-25/basic/security_best_practices#attacks-and-mitigations)
- [Confused Deputy Problem](https://modelcontextprotocol.io/specification/2025-11-25/basic/security_best_practices#confused-deputy-problem)
- [Terminology](https://modelcontextprotocol.io/specification/2025-11-25/basic/security_best_practices#terminology)
- [Vulnerable Conditions](https://modelcontextprotocol.io/specification/2025-11-25/basic/security_best_practices#vulnerable-conditions)
- [Architecture and Attack Flows](https://modelcontextprotocol.io/specification/2025-11-25/basic/security_best_practices#architecture-and-attack-flows)
- [Attack Description](https://modelcontextprotocol.io/specification/2025-11-25/basic/security_best_practices#attack-description)
- [Mitigation](https://modelcontextprotocol.io/specification/2025-11-25/basic/security_best_practices#mitigation)
- [Token Passthrough](https://modelcontextprotocol.io/specification/2025-11-25/basic/security_best_practices#token-passthrough)
- [Risks](https://modelcontextprotocol.io/specification/2025-11-25/basic/security_best_practices#risks)
- [Mitigation](https://modelcontextprotocol.io/specification/2025-11-25/basic/security_best_practices#mitigation-2)
- [Session Hijacking](https://modelcontextprotocol.io/specification/2025-11-25/basic/security_best_practices#session-hijacking)
- [Session Hijack Prompt Injection](https://modelcontextprotocol.io/specification/2025-11-25/basic/security_best_practices#session-hijack-prompt-injection)
- [Session Hijack Impersonation](https://modelcontextprotocol.io/specification/2025-11-25/basic/security_best_practices#session-hijack-impersonation)
- [Attack Description](https://modelcontextprotocol.io/specification/2025-11-25/basic/security_best_practices#attack-description-2)
- [Mitigation](https://modelcontextprotocol.io/specification/2025-11-25/basic/security_best_practices#mitigation-3)
- [Local MCP Server Compromise](https://modelcontextprotocol.io/specification/2025-11-25/basic/security_best_practices#local-mcp-server-compromise)
- [Attack Description](https://modelcontextprotocol.io/specification/2025-11-25/basic/security_best_practices#attack-description-3)
- [Risks](https://modelcontextprotocol.io/specification/2025-11-25/basic/security_best_practices#risks-2)
- [Mitigation](https://modelcontextprotocol.io/specification/2025-11-25/basic/security_best_practices#mitigation-4)
- [Scope Minimization](https://modelcontextprotocol.io/specification/2025-11-25/basic/security_best_practices#scope-minimization)
- [Attack Description](https://modelcontextprotocol.io/specification/2025-11-25/basic/security_best_practices#attack-description-4)
- [Risks](https://modelcontextprotocol.io/specification/2025-11-25/basic/security_best_practices#risks-3)
- [Mitigation](https://modelcontextprotocol.io/specification/2025-11-25/basic/security_best_practices#mitigation-5)
- [Common Mistakes](https://modelcontextprotocol.io/specification/2025-11-25/basic/security_best_practices#common-mistakes)
...
## [​](https://modelcontextprotocol.io/specification/2025-11-25/basic/security_best_practices#introduction) Introduction

### [​](https://modelcontextprotocol.io/specification/2025-11-25/basic/security_best_practices#purpose-and-scope) Purpose and Scope

This document provides security considerations for the Model Context Protocol (MCP), complementing the [MCP Authorization](https://modelcontextprotocol.io/specification/2025-11-25/basic/authorization.mdx) specification. This document identifies security risks, attack vectors, and best practices specific to MCP implementations.The primary audience for this document includes developers implementing MCP authorization flows, MCP server operators, and security professionals evaluating MCP-based systems. This document should be read alongside the MCP Authorization specification and [OAuth 2.0 security best practices](https://datatracker.ietf.org/doc/html/rfc9700).

## [​](https://modelcontextprotocol.io/specification/2025-11-25/basic/security_best_practices#attacks-and-mitigations) Attacks and Mitigations

This section gives a detailed description of attacks on MCP implementations, along with potential countermeasures.

### [​](https://modelcontextprotocol.io/specification/2025-11-25/basic/security_best_practices#confused-deputy-problem) Confused Deputy Problem
...
#### [​](https://modelcontextprotocol.io/specification/2025-11-25/basic/security_best_practices#terminology) Terminology
...
#### [​](https://modelcontextprotocol.io/specification/2025-11-25/basic/security_best_practices#vulnerable-conditions) Vulnerable Conditions
...
#### [​](https://modelcontextprotocol.io/specification/2025-11-25/basic/security_best_practices#architecture-and-attack-flows) Architecture and Attack Flows
...
#### [​](https://modelcontextprotocol.io/specification/2025-11-25/basic/security_best_practices#attack-description) Attack Description
...
6. The MCP authorization code is redirected to the attacker’s server (specified in the malicious `redirect_uri` parameter during [dynamic client registration](https://modelcontextprotocol.io/specification/2025-11-25/basic/authorization#dynamic-client-registration))
7. The attacker exchanges the stolen authorization code for access tokens for the MCP server without the user’s explicit approval
8. The attacker now has access to the third-party API as the compromised user

#### [​](https://modelcontextprotocol.io/specification/2025-11-25/basic/security_best_practices#mitigation) Mitigation
...
Third-Party AuthZ ServerMCP ServerUser's BrowserMCP ClientThird-Party AuthZ ServerMCP ServerUser's BrowserMCP Client1\. Client Registration (Dynamic)2\. Authorization RequestNot previously approvedalt\[Check MCP Server Consent\]"Allow \[Client Name\] to access \[Third-Party API\]?"3\. Forward to Third-PartyUse static client_id for third-partyRegister with redirect_uriclient_idOpen MCP server authorization URLGET /authorize?client_id=...&redirect_uri=...Check consent for this client_idShow MCP server-owned consent pagePOST /consent (approve)Store consent decision for client_idRedirect to third-party /authorizeAuthorization request (static client_id)User authenticates & consentsRedirect with auth codeCallback with third-party codeExchange code for token (using static client_id)Redirect to client's registered redirect_uri
...
### [​](https://modelcontextprotocol.io/specification/2025-11-25/basic/security_best_practices#token-passthrough) Token Passthrough
...
#### [​](https://modelcontextprotocol.io/specification/2025-11-25/basic/security_best_practices#risks) Risks

Token passthrough is explicitly forbidden in the [authorization specification](https://modelcontextprotocol.io/specification/2025-11-25/basic/authorization) as it introduces a number of security risks, that include:
...
#### [​](https://modelcontextprotocol.io/specification/2025-11-25/basic/security_best_practices#mitigation-2) Mitigation

MCP servers **MUST NOT** accept any tokens that were not explicitly issued for the MCP server.

### [​](https://modelcontextprotocol.io/specification/2025-11-25/basic/security_best_practices#session-hijacking) Session Hijacking
...
#### [​](https://modelcontextprotocol.io/specification/2025-11-25/basic/security_best_practices#session-hijack-prompt-injection) Session Hijack Prompt Injection
...
#### [​](https://modelcontextprotocol.io/specification/2025-11-25/basic/security_best_practices#session-hijack-impersonation) Session Hijack Impersonation
...
#### [​](https://modelcontextprotocol.io/specification/2025-11-25/basic/security_best_practices#attack-description-2) Attack Description
...
#### [​](https://modelcontextprotocol.io/specification/2025-11-25/basic/security_best_practices#mitigation-3) Mitigation
...
### [​](https://modelcontextprotocol.io/specification/2025-11-25/basic/security_best_practices#local-mcp-server-compromise) Local MCP Server Compromise
...
#### [​](https://modelcontextprotocol.io/specification/2025-11-25/basic/security_best_practices#attack-description-3) Attack Description
...
#### [​](https://modelcontextprotocol.io/specification/2025-11-25/basic/security_best_practices#risks-2) Risks
...
#### [​](https://modelcontextprotocol.io/specification/2025-11-25/basic/security_best_practices#mitigation-4) Mitigation
...
### [​](https://modelcontextprotocol.io/specification/2025-11-25/basic/security_best_practices#scope-minimization) Scope Minimization

Poor scope design increases token compromise impact, elevates user friction, and obscures audit trails.

#### [​](https://modelcontextprotocol.io/specification/2025-11-25/basic/security_best_practices#attack-description-4) Attack Description
...
#### [​](https://modelcontextprotocol.io/specification/2025-11-25/basic/security_best_practices#risks-3) Risks
...
#### [​](https://modelcontextprotocol.io/specification/2025-11-25/basic/security_best_practices#mitigation-5) Mitigation
...
#### [​](https://modelcontextprotocol.io/specification/2025-11-25/basic/security_best_practices#common-mistakes) Common Mistakes
...
[Authorization](https://modelcontextprotocol.io/specification/2025-11-25/basic/authorization) [Cancellation](https://modelcontextprotocol.io/specification/2025-11-25/basic/utilities/cancellation)
