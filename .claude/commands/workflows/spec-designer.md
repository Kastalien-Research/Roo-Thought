...
Design and produce implementation specifications through structured cognitive loops. This is the upstream companion to `/spec-orchestrator`—where the orchestrator _implements_ specs, the designer _creates_ them.
...
_This workflow composes OODA loop building blocks from the @loops/ library to produce implementation-ready specifications. The modular architecture enables reuse of loops across different workflows._
