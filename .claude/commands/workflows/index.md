...
Design and produce implementation specifications through structured cognitive loops. Upstream companion to spec-orchestrator—where the orchestrator _implements_ specs, the designer _creates_ them.
