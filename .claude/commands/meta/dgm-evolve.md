...
The original Godel Machine required _mathematical proof_ that a self-modification would improve performance. This is impractical. The Darwin Godel Machine (DGM) instead uses _empirical evidence_ - like evolution, where the deer that survives the lion didn't prove it was faster; it just was.
