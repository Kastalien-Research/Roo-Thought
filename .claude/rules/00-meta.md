...
**DGM**: The original Godel Machine required _mathematical proof_ that a self-modification would improve performance. DGM uses _empirical evidence_ instead - like evolution, where the deer that survives the lion didn't prove it was faster; it just was.
